...
class AliancaComunidadeMensagem extends Model
{
    use HasFactory;

    protected $table = 'alianca_comunidade_mensagens';
    ...
    {
        return $this->hasMany(AliancaComunidadeLeitura::class, 'mensagem_id');
    }
    ...
    public function getTipoMensagemFormatado(): string
    {
        return match($this->getTipoMensagem()) {
            'texto' => 'Texto',
            'imagem' => 'Imagem',
            'audio' => 'Áudio',
            'video' => 'Vídeo',
            ...
            default => ucfirst($this->getTipoMensagem())
        };
    }

    public function getIconeTipoMensagem(): string
    {
        return match($this->getTipoMensagem()) {
            'texto' => 'fas fa-comment',
            'imagem' => 'fas fa-image',
            'audio' => 'fas fa-music',
            'video' => 'fas fa-video',
            'arquivo' => 'fas fa-file',
    ...
    {
        // Mensagens só podem ser editadas por até 5 minutos após envio
        return $this->created_at->diffInMinutes(now()) <= 5;
    }

    public function podeSerDeletada(): bool
    {
        // Mensagens só podem ser deletadas pelo autor ou admin
    ...
    {
        return $query->whereNotNull('anexos');
    }
