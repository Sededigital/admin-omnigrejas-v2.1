...
<head>
    ...
    <title>Pagamento Aprovado - <?php echo e(config('app.name')); ?></title>
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 40px 30px; background-color: #ffffff;">
                            ...
                            <p style="font-size: 16px; color: #374151; margin: 0 0 16px 0; line-height: 1.7;">
                                Sua assinatura foi ativada com sucesso. Você agora tem acesso completo aos recursos do <strong style="color: #059669;"><?php echo e(config('app.name')); ?></strong>.
                            </p>
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td style="padding: 8px 0; color: #6b7280;"><?php echo e($pacoteNome); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-weight: 600; color: #374151;">Tipo:</td>
                                                <td style="padding: 8px 0; color: #6b7280;"><?php echo e($tipoAssinatura); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-weight: 600; color: #374151;">Valor Pago:</td>
                                                <td style="padding: 8px 0; color: #6b7280;"><?php echo e($valor); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-weight: 600; color: #374151;">Data de Início:</td>
                                                <td style="padding: 8px 0; color: #6b7280;"><?php echo e($dataInicio); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-weight: 600; color: #374151;">Data de Fim:</td>
                                                <td style="padding: 8px 0; color: #6b7280;"><?php echo e($dataFim); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 36px; margin-bottom: 36px;">
                                <tr>
                                    <td align="center">
                                        ...
                                        <a href="<?php echo e(url('/dashboard-church')); ?>" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: white; text-decoration: none; padding: 16px 36px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(5, 150, 105, 0.2); transition: all 0.3s ease;">
                            ...
                            <p style="font-size: 16px; color: #059669; margin: 0 0 32px 0;">
                                <a href="<?php echo e(url('/dashboard-church')); ?>" style="color: #059669; text-decoration: underline;"><?php echo e(url('/dashboard-church')); ?></a>
                            </p>
                            ...
                            <p style="margin: 0; color: #111827; font-size: 14px;">
                                <strong style="font-weight: 700;">Atenciosamente,<br>Equipe <?php echo e(config('app.name')); ?></strong>
                            </p>
...
</html><?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/emails/pagamento-aprovado.blade.php ENDPATH**/ ?>