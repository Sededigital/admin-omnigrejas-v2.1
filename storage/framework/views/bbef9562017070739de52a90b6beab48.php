    ...
    <nav class="nav navbar  navbar-expand-xl navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php if(Auth::user()?->isIgrejaAdmin()): ?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?php echo e(route('churches.community-nav')); ?>" wire:navigate wire:current='active'>
                    ...
                    <?php if(($permissionHelper->hasPermission('gerenciar_chats') || $permissionHelper->hasPermission('gerenciar_chats_igreja'))
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownPages">
                                ...
                                && ($resourceHelper->userCanAccessResource('gerenciar_chats') || $resourceHelper->userCanAccessResource('gerenciar_chats_igreja'))): ?>
                                    <li>
                                        <a class="dropdown-item d-flex justify-content-between align-items-center" href="<?php echo e(route('churches.chat-nav', [])); ?>" wire:navigate>
                                            Igreja
                                        </a>
                                    </li>
                                <?php endif; ?>
...
[$__name, $__params] = $__split('navbar.select-church');

$__html = app('livewire')->mount($__name, $__params, 'lw-3259933390-0', $__slots ?? [], get_defined_vars());
...
?>
                ...
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('ecommerce.home')); ?>" class="nav-link text-warning" wire:navigate title="Loja Omnigrejas">
                    ...
                    <li class="nav-item dropdown" id="itemdropdown1">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="<?php echo e(url('/profile')); ?>" wire:navigate >Perfil</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('user/two-factor-authentication')); ?>" wire:navigate >Definições</a></li>
                            <li><hr class="dropdown-divider"></li>
...
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/components/layouts/nav/nav.blade.php ENDPATH**/ ?>