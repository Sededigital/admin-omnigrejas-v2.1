    ...
    <div class="container-fluid p-4">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($user->isIgrejaAdmin() || $user->isSuperAdmin()): ?>
        ...
        <div class="card mb-4">
            <div class="card-body text-center">
                <div class="mb-3">
                    <!--[if BLOCK]><![endif]--><?php if($user->photo_url): ?>
                        <img src="<?php echo e(Storage::disk('supabase')->url($user->photo_url)); ?>" alt="Foto de perfil"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    ...
                                    <span class="text-dark"><?php echo e($user->phone ?: 'Não informado'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <small class="text-muted d-block fw-semibold">Função</small>
                                    <span class="badge bg-primary"><?php echo e($user->getRoleLabel()); ?></span>
                                </div>
                            </div>

                            <!-- Informações da Igreja -->
                            <!--[if BLOCK]><![endif]--><?php if($cargo): ?>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <small class="text-muted d-block fw-semibold">Cargo na Igreja</small>
                                    <span class="badge bg-info"><?php echo e(ucfirst($cargo)); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($data_entrada): ?>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <small class="text-muted d-block fw-semibold">Membro desde</small>
                                    <span class="text-dark"><?php echo e(\Carbon\Carbon::parse($data_entrada)->format('d/m/Y')); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($numero_membro): ?>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <small class="text-muted d-block fw-semibold">Número do Membro</small>
                                    <span class="text-dark"><?php echo e($numero_membro); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($membroPerfil && $membroPerfil->genero): ?>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <small class="text-muted d-block fw-semibold">Gênero</small>
                                    <span class="text-dark"><?php echo e(ucfirst($membroPerfil->genero)); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($membroPerfil && $membroPerfil->data_nascimento): ?>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <small class="text-muted d-block fw-semibold">Data de Nascimento</small>
                                    <span class="text-dark"><?php echo e(\Carbon\Carbon::parse($membroPerfil->data_nascimento)->format('d/m/Y')); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($membroPerfil && $membroPerfil->endereco): ?>
                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <small class="text-muted d-block fw-semibold">Endereço</small>
                                    <span class="text-dark"><?php echo e($membroPerfil->endereco); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($membroPerfil && $membroPerfil->observacoes): ?>
                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <small class="text-muted d-block fw-semibold">Observações</small>
                                    <span class="text-dark"><?php echo e($membroPerfil->observacoes); ?></span>
                                </div>
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3 p-2 rounded bg-light">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-<?php echo e($user->is_active ? 'check-circle text-success' : 'times-circle text-secondary'); ?> me-2 fs-5"></i>
                                        <div>
                                            <small class="text-muted d-block mb-0">Status</small>
                                            <span class="fw-semibold"><?php echo e($user->is_active ? 'Ativa' : 'Inativa'); ?></span>
                                        </div>
                                    </div>
                                    <span class="badge bg-<?php echo e($user->is_active ? 'success' : 'secondary'); ?> fs-6">
                                        <i class="fas fa-<?php echo e($user->is_active ? 'check' : 'times'); ?> me-1"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3 p-2 rounded bg-light">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-<?php echo e($user->hasVerifiedEmail() ? 'envelope-open text-success' : 'envelope text-warning'); ?> me-2 fs-5"></i>
                                        <div>
                                            <small class="text-muted d-block mb-0">Email</small>
                                            <span class="fw-semibold"><?php echo e($user->hasVerifiedEmail() ? 'Verificado' : 'Pendente'); ?></span>
                                        </div>
                                    </div>
                                    <span class="badge bg-<?php echo e($user->hasVerifiedEmail() ? 'success' : 'warning'); ?> fs-6">
                                        <i class="fas fa-<?php echo e($user->hasVerifiedEmail() ? 'check' : 'clock'); ?> me-1"></i>
                                        <?php echo e($user->hasVerifiedEmail() ? 'OK' : 'Aguardando'); ?>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3 p-2 rounded bg-light">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-<?php echo e($user->two_factor_confirmed_at ? 'lock text-success' : 'unlock text-muted'); ?> me-2 fs-5"></i>
                                        <div>
                                            <small class="text-muted d-block mb-0">2FA</small>
                                            <span class="fw-semibold"><?php echo e($user->two_factor_confirmed_at ? 'Ativado' : 'Desativado'); ?></span>
                                        </div>
                                    </div>
                                    <span class="badge bg-<?php echo e($user->two_factor_confirmed_at ? 'success' : 'secondary'); ?> fs-6">
                                        <i class="fas fa-<?php echo e($user->two_factor_confirmed_at ? 'shield-alt' : 'shield'); ?> me-1"></i>
                                        <?php echo e($user->two_factor_confirmed_at ? 'Protegido' : 'Desprotegido'); ?>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <button class="btn btn-outline-info btn-sm" wire:navigate href="<?php echo e(route('two-factor.show')); ?>">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"  autocomplete="new-password" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="email" autocomplete="new-password"  class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"  autocomplete="new-password" class="form-control" value="<?php echo e($user->getRoleLabel()); ?>" readonly id="role">
                                            <label for="role">
...
unset($__errorArgs, $__bag); ?>" wire:model="genero" id="genero">
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['data_nascimento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                                ...
                                <div class="mt-4 p-3 bg-light rounded">
                                    ...
                                    <div class="row g-2 text-sm">
                                        <div class="col-md-6">
                                            ...
                                            <span class="ms-1 fw-semibold"><?php echo e(ucfirst($cargo)); ?></span>
                                        </div>
                                        <!--[if BLOCK]><![endif]--><?php if($data_entrada): ?>
                                        <div class="col-md-6">
                                            <small class="text-muted">Membro desde:</small>
                                            <span class="ms-1 fw-semibold"><?php echo e(\Carbon\Carbon::parse($data_entrada)->format('d/m/Y')); ?></span>
                                        </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($numero_membro): ?>
                                        <div class="col-md-6">
                                            <small class="text-muted">Número:</small>
                                            <span class="ms-1 fw-semibold"><?php echo e($numero_membro); ?></span>
                                        </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                ...
                <form wire:submit.prevent="updatePassword">
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="password" autocomplete="new-password"   class="form-control <?php $__errorArgs = ['current_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="password" autocomplete="new-password"   class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text"  autocomplete="new-password" class="form-control <?php $__errorArgs = ['igreja_nome'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['igreja_nome'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"  autocomplete="new-password" class="form-control <?php $__errorArgs = ['igreja_sigla'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['igreja_sigla'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control <?php $__errorArgs = ['igreja_descricao'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['igreja_descricao'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"  autocomplete="new-password" class="form-control <?php $__errorArgs = ['igreja_contacto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['igreja_contacto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"  autocomplete="new-password" class="form-control <?php $__errorArgs = ['igreja_localizacao'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['igreja_localizacao'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-12">
                                ...
                                <input type="file" class="form-control <?php $__errorArgs = ['igreja_logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['igreja_logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="text-center mb-4">
                        <div class="position-relative d-inline-block">
                            <!--[if BLOCK]><![endif]--><?php if($user->photo_url): ?>
                                <img src="<?php echo e(Storage::disk('supabase')->url($user->photo_url)); ?>" alt="Foto atual"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" class="form-control <?php $__errorArgs = ['upload_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['upload_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/profile/show.blade.php ENDPATH**/ ?>