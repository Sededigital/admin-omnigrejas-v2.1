...
<head>
    ...
    <title>Ficha de Membro - <?php echo e($member->user->name); ?></title>
    <style>
...
<body>
    ...
    <img src="<?php echo e(asset('system/img/logo-system/icon.png')); ?>" alt="Omnigrejas" class="system-logo">
    ...
    <div class="doc-number-container">
        <p style="font-size: 9pt; color: #777; margin: 0;">
            DOC. N.º: <?php echo e(now()->format('Y/m/d')); ?>/<?php echo e($numero_membro); ?>-<?php echo e(now()->timestamp); ?>
    ...
    <div class="header">
        <div class="header-main-center">
            <?php if($member->igreja->logo): ?>
                <img src="<?php echo e(Storage::disk('supabase')->url($member->igreja->logo)); ?>" alt="Logo da Igreja" class="church-logo">
            <?php else: ?>
                <div class="logo-placeholder">LOGO</div>
            <?php endif; ?>

            <div class="church-info">
                <h1><?php echo e($member->igreja->nome); ?></h1>
                <p><?php echo e($member->igreja->sigla ? '(' . $member->igreja->sigla . ')' : ''); ?></p>
                <p>NIF: <?php echo e($member->igreja->nif ?? 'Não informado'); ?></p>
                <p>Contato: <?php echo e($member->igreja->contacto ?? 'Não informado'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="data-section">
        ...
        <div style="text-align: center; margin-bottom: 15px;">
            <?php if($member->user->photo_url): ?>
                <img src="<?php echo e(Storage::disk('supabase')->url($member->user->photo_url)); ?>" alt="Foto do Membro" class="member-photo">
            <?php else: ?>
                <div class="photo-placeholder"><?php echo e(strtoupper(substr($member->user->name ?? 'N', 0, 2))); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="two-columns">
            ...
            <div class="col">
                <div class="data-field">
                    ...
                    <span class="data-value"><?php echo e($member->user->name); ?></span>
                </div>
                <div class="data-field">
                    <span class="data-label">Email:</span>
                    <span class="data-value"><?php echo e($member->user->email); ?></span>
                </div>
                <div class="data-field">
                    <span class="data-label">Telefone:</span>
                    <span class="data-value"><?php echo e($member->user->phone ?? 'Não informado'); ?></span>
                </div>
                <div class="data-field">
                    <span class="data-label">Gênero:</span>
                    <span class="data-value"><?php echo e(ucfirst($member->membroPerfil->genero ?? 'Não informado')); ?></span>
                </div>
            </div>
            ...
            <div class="col">
                <div class="data-field">
                    ...
                    <span class="data-value"><?php echo e($numero_membro); ?></span>
                </div>
                <div class="data-field">
                    <span class="data-label">Cargo:</span>
                    <span class="data-value"><?php echo e(ucfirst($member->cargo)); ?></span>
                </div>
                <div class="data-field">
                    <span class="data-label">Data de Entrada:</span>
                    <span class="data-value"><?php echo e($data_entrada); ?></span>
                </div>
                <div class="data-field">
                    <span class="data-label">Status:</span>
                    <span class="data-value"><?php echo e(ucfirst($member->status)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="data-field" style="padding-top: 5px;">
            ...
            <span class="data-value"><?php echo e($member->membroPerfil->endereco ?? 'Não informado'); ?></span>
        </div>

        <!-- Observações se existirem -->
        <?php if($member->membroPerfil->observacoes): ?>
        <div class="data-field" style="padding-top: 5px;">
            <span class="data-label">Observações:</span>
            <span class="data-value"><?php echo e($member->membroPerfil->observacoes); ?></span>
        </div>
        <?php endif; ?>
    </div>

    <!-- Seção de Ministérios (se houver) -->
    <?php if($member->ministerios && $member->ministerios->count() > 0): ?>
    <div class="data-section">
        <div class="section-title">
            MINISTÉRIOS
        </div>
        <div style="display: flex; flex-wrap: wrap; gap: 10px;">
            <?php $__currentLoopData = $member->ministerios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ministerio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span style="background: #e9ecef; padding: 3px 8px; border-radius: 12px; font-size: 9pt; color: #495057;">
                    <?php echo e($ministerio->nome); ?>
    ...
    <div class="important-note">
        ...
        A Igreja <?php echo e($member->igreja->nome); ?> certifica que
        <span style="font-weight: bold;"><?php echo e($member->user->name); ?></span>
        é membro ativo desta congregação, registrado sob o número
        <span style="font-weight: bold;"><?php echo e($numero_membro); ?></span>,
    ...
    <div style="text-align: center; margin-top: 30px; padding: 10px; border: 1px solid #000; display: inline-block;">
        <strong>DATA DE EMISSÃO: <?php echo e($data_emissao); ?></strong>
    </div>
    ...
    <div class="footer" style="margin-top: 80px;">
        <p>Documento gerado pelo **Sistema Omnigreja** em <?php echo e(now()->format('d/m/Y H:i:s')); ?> (ID de Rastreio: <?php echo e(now()->timestamp); ?>)</p>
        <p>A autenticidade deste documento pode ser verificada junto à igreja emissora.</p>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/church/members/pdf/member-card.blade.php ENDPATH**/ ?>