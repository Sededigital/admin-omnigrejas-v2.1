<?php if(Auth::user()->role == 'admin' || Auth::user()->role == 'pastor' || Auth::user()->role == 'ministro' || Auth::user()->role == 'super_admin'): ?>
      



<?php
    $resourceHelper = new \App\Helpers\Billings\ResourceHelper();
    $assinatura = $resourceHelper->getIgrejaAssinatura();
    $mostrarBotaoLicenca = $assinatura && $assinatura->isExpiringSoon(15);
?>

<?php if($mostrarBotaoLicenca): ?>
<a class="btn btn-fixed-end btn-danger btn-icon btn-dashboard z-3" href="<?php echo e(route('ecommerce.home')); ?>" target="_blank">
      Licença Produto
</a>
<?php endif; ?>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" data-bs-scroll="true" data-bs-backdrop="true"
      ...
      <div class="offcanvas-header">
        <div class="d-flex align-items-center">
          <h3 class="offcanvas-title me-3" id="offcanvasExampleLabel">Definições</h3>
        </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color"
                ...
                <span class=""> predefinido </span>
              </div>
              <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color"
                data-value="sidebar-dark">
                <span class=""> Escuro </span>
              </div>
              <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color"
            ...
            <hr class="hr-horizontal">
            <h5 class="mt-4 mb-3">Tipo de Sidebar</h5>
            <div class="d-grid gap-3 grid-cols-3 mb-4">
              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/03.png')); ?>" alt="mini"
                ...
                <img src="<?php echo e(asset('assets/images/settings/light/03.png')); ?>" alt="mini"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                  data-name="sidebar-type" data-value="sidebar-mini">
                <span class="mt-2">Mini</span>
              </div>
              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/04.png')); ?>" alt="hover"
                  class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                  data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                <img src="<?php echo e(asset('assets/images/settings/light/04.png')); ?>" alt="hover"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                  data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                <span class="mt-2">Hover</span>
              </div>
              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/05.png')); ?>" alt="boxed"
                  class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                  data-name="sidebar-type" data-value="sidebar-boxed">
                <img src="<?php echo e(asset('assets/images/settings/light/05.png')); ?>" alt="boxed"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                  data-name="sidebar-type" data-value="sidebar-boxed">
                <span class="mt-2">Encaixado</span>
              </div>
            </div>
            <hr class="hr-horizontal">
            <h5 class="mt-4 mb-3">Estilo ativo Sidebar</h5>
            <div class="d-grid gap-3 grid-cols-2 mb-4">

              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/07.png')); ?>" alt="rounded-all"
                ...
                <img src="<?php echo e(asset('assets/images/settings/light/07.png')); ?>" alt="rounded-all"
                  class="mode light-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="sidebar"
                  data-name="sidebar-item" data-value="navs-rounded-all">
                <span class="mt-2">Tudo redondo</span>
              </div>

              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/09.png')); ?>" alt="pill-all"
                ...
                <img src="<?php echo e(asset('assets/images/settings/light/08.png')); ?>" alt="pill-all"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                  data-name="sidebar-item" data-value="navs-pill-all">
                <span class="mt-2">Todo redondo</span>
              </div>
            </div>
            <hr class="hr-horizontal">
            <h5 class="mt-4 mb-3">Estilo navegação</h5>
            <div class="d-grid gap-3 grid-cols-2 ">
              <div class=" text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/11.png')); ?>" alt="image"
                ...
                <img src="<?php echo e(asset('assets/images/settings/light/10.png')); ?>" alt="image"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                  data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                <span class="mt-2">Vidrado</span>
              </div>
              <div class=" text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/12.png')); ?>" alt="sticky"
                  class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                  data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                <img src="<?php echo e(asset('assets/images/settings/light/12.png')); ?>" alt="sticky"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                  data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                <span class="mt-2">Fixo</span>
              </div>
              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/13.png')); ?>" alt="transparent"
                  class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                  data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                <img src="<?php echo e(asset('assets/images/settings/light/13.png')); ?>" alt="transparent"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                  data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                <span class="mt-2">Transparentes</span>
              </div>
              <div class="text-center">
                <img src="<?php echo e(asset('assets/images/settings/dark/10.png')); ?>" alt="color"
                  class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                  data-target=".iq-navbar" data-name="navbar-type" data-value="default">
                <img src="<?php echo e(asset('assets/images/settings/light/01.png')); ?>" alt="color"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
              ...
              <div class="btn btn-border active col-span-full mt-4 d-block" data-setting="navbar" data-name="navbar-default"
                data-value="default">
                <span class=""> Refazer Navbar</span>
              </div>
            </div>
          </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/components/layouts/footer/first-footer.blade.php ENDPATH**/ ?>