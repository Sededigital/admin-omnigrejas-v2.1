<div>
    <div class="container-fluid p-4">
                ...
                <div class="row g-3">
                        ...
                        <select class="form-select" wire:model.live="filtroPastor">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(isset($pastoresDisponiveis)): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $pastoresDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pastor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pastor['id']); ?>"><?php echo e($pastor['nome']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-control-plaintext pt-2">
                            <strong><?php echo e(count($atendimentos)); ?></strong> atendimento(s) encontrado(s)
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <!--[if BLOCK]><![endif]--><?php if(!empty($atendimentos)): ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $atendimentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atendimento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-0">
                                        <i class="fas fa-<?php echo e($atendimento->tipo === 'aconselhamento' ? 'comments' : ($atendimento->tipo === 'visita' ? 'home' : ($atendimento->tipo === 'oracao' ? 'pray' : ($atendimento->tipo === 'encorajamento' ? 'heart' : 'question')) )); ?> text-primary me-2"></i>
                                        <?php echo e(ucfirst($atendimento->tipo)); ?>

                                    </h6>
                                    <small class="text-muted">
                                        <i class="fas fa-calendar me-1"></i>
                                        <?php echo e($atendimento->data_atendimento ? $atendimento->data_atendimento->format('d/m/Y') : 'Data não informada'); ?>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#" wire:click="openModal('<?php echo e($atendimento->id); ?>')" data-bs-toggle="modal" data-bs-target="#pastoralCareModal">
                                            <i class="fas fa-edit me-2"></i>Editar
                                        </a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item text-danger" href="#" wire:click="excluirAtendimento('<?php echo e($atendimento->id); ?>')">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <p class="mb-2"><?php echo e($atendimento->membro->user->name); ?></p>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="mb-2"><?php echo e($atendimento->pastor->name); ?></p>
                                </div>

                                <!--[if BLOCK]><![endif]--><?php if($atendimento->descricao): ?>
                                    <div class="mb-3">
                                        <strong class="text-primary">
                                            <i class="fas fa-align-left me-1"></i>Descrição:
                                        </strong>
                                        <p class="mb-2"><?php echo e(Str::limit($atendimento->descricao, 100)); ?></p>
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="badge bg-info">
                                        ...
                                        <?php echo e($atendimento->created_at->diffForHumans()); ?>
                    ...
                    <div class="card">
                        <div class="card-body text-center py-5">
                            ...
                            <p class="text-muted mb-4">
                                <!--[if BLOCK]><![endif]--><?php if($filtroTipo || $filtroPastor || $filtroMembro): ?>
        ...
        <?php echo $__env->make('church.only.modals.pastoral-care-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    </div>
</div>
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/church/only/pastoral-care.blade.php ENDPATH**/ ?>