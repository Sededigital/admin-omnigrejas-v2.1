    ...
    <div class="container-fluid p-4">
        ...
        <div class="row" style="height: calc(100vh - 100px);">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card h-100">
                    ...
                    <div class="card-body p-0" style="overflow-y: auto; height: calc(100vh - 200px);">
                        <!--[if BLOCK]><![endif]--><?php if(!empty($chats)): ?>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="alliance-item p-3 border-bottom cursor-pointer <?php echo e($chatAtivo == $chat['id'] ? 'bg-primary text-white' : 'hover-bg-light'); ?>"
                                     wire:click="selecionarChat('<?php echo e($chat['id']); ?>')">
                                    <div class="d-flex align-items-center">
                                        <div class="alliance-avatar me-3">
                                            <i class="fas fa-comment-dots text-<?php echo e($chatAtivo == $chat['id'] ? 'white' : 'primary'); ?>" style="font-size: 1.5rem;"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="fw-semibold"><?php echo e(Str::limit($chat['nome'], 20)); ?></div>
                                            <small class="<?php echo e($chatAtivo == $chat['id'] ? 'text-white-50' : 'text-muted'); ?>">
                                                <!--[if BLOCK]><![endif]--><?php if($chatAtivo == $chat['id']): ?>
                                                    <?php echo e(count($mensagens ?? [])); ?> mensagens
                                                <?php else: ?>
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($chat['mensagens'])): ?>
                                                        <?php echo e(Str::limit($chat['mensagens'][0]['conteudo'] ?? '', 25)); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($chatAtivo != $chat['id'] && !empty($chat['mensagens'])): ?>
                                            <span class="badge bg-danger ms-2"><?php echo e(count($chat['mensagens'])); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
            ...
            <div class="col-md-8 col-lg-9">
                <!--[if BLOCK]><![endif]--><?php if($chatAtivo): ?>
                    <?php
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="">
                                <h6 class="mb-0" style="cursor: pointer;" onclick="abrirSobreChat()">
                                    ...
                                    <?php echo e($chatSelecionado['nome'] ?? 'Chat da Igreja'); ?>

                                </h6>
                                <small class="text-muted m-2 mb-2 mt-2">
                                    <i class="fas fa-circle text-success me-1" style="font-size: 8px;"></i>
                                    Chat da igreja • <?php echo e(count($chats)); ?> chats disponíveis
                                </small>
                            </div>
                            <div class="dropdown">
                        ...
                        <div class="card-body p-0 d-flex flex-column" style="height: calc(100vh - 200px);">
                            ...
                            <div class="chat-messages" id="churchChatMessages" style="overflow-y: auto !important; padding: 10px !important; height: calc(100vh - 200px) !important; min-height: 200px !important; max-height: calc(100vh - 130px) !important; display: block !important; visibility: visible !important; background: #f8f9fa !important; border: 1px solid #dee2e6 !important; margin-bottom: 0 !important;">
                                ...
                                <!-- Mensagens reais -->
                                <!--[if BLOCK]><![endif]--><?php if(!empty($mensagens)): ?>
                                            ...
                                            <div class="message-bubble" style="display: inline-block !important; visibility: visible !important; max-width: 75% !important; padding: 6px 10px !important; border-radius: <?php echo e($isOwn ? '18px 18px 4px 18px' : '18px 18px 18px 4px'); ?> !important; background-color: <?php echo e($isOwn ? '#dcf8c6' : 'white'); ?> !important; color: #303030 !important; <?php echo e(!$isOwn ? 'border: 1px solid #e0e0e0 !important;' : ''); ?> position: relative !important; font-size: 14px !important; line-height: 1.3 !important; word-wrap: break-word !important; box-shadow: 0 1px 2px rgba(0,0,0,0.1) !important;">
                                                    <!--[if BLOCK]><![endif]--><?php if($mensagem['tipo_mensagem'] === 'audio'): ?>
                                                        ...
                                                        <div class="whatsapp-audio-player" style="display: flex !important; align-items: center !important; gap: 10px !important; padding: 8px !important; background: rgba(0,0,0,0.05) !important; border-radius: 12px !important; margin-bottom: 5px !important; min-width: 200px !important;">
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php if($isOwn || $isAdminGrupo): ?>
                                                                <button class="btn btn-sm btn-link p-0 text-danger audio-delete-btn"
                                                                        onclick="confirmarDeletarMensagem('<?php echo e($mensagem['id']); ?>')"
                                                    ...
                                                    <div class="message-info" style="display: flex !important; visibility: visible !important; justify-content: flex-end !important; align-items: center !important; margin-top: 3px !important; gap: 3px !important;">
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php if($mensagem['tipo_mensagem'] !== 'audio' && ($isOwn || $isAdminGrupo)): ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  autocomplete="new-password" autocomplete="new-password" 
                               class="form-control <?php $__errorArgs = ['nomeChat'];
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               maxlength="255">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nomeChat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['descricaoChat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['descricaoChat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['visibilidadeChat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/church/alliance/church-chat.blade.php ENDPATH**/ ?>