    ...
    <div class="container-fluid">
                                ...
                                <div class="d-flex justify-content-end align-items-center gap-3">
                                    ...
                                    <div class="text-center">
                                        <div class="bg-primary bg-opacity-10 rounded-3 px-3 py-2 border">
                                            <div class="text-primary fw-bold fs-5"><?php echo e($pagamentosPendentes->count()); ?></div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-4">
                                    <div class="d-flex align-items-center text-muted">
                                        ...
                                        <small class="fw-medium">Última atualização: <?php echo e(now()->format('H:i:s')); ?></small>
                                    </div>
                                    <div class="vr" style="height: 16px;"></div>
                                    <div class="d-flex align-items-center text-muted">
                                        <i class="fas fa-eye me-2"></i>
                                        <small class="fw-medium"><?php echo e($pagamentosPendentes->count()); ?> solicitações aguardando análise</small>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <!--[if BLOCK]><![endif]--><?php if($pagamentosPendentes->count() > 0): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $pagamentosPendentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pagamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    
                                                    <div class="avatar avatar-sm me-3">
                                                        <!--[if BLOCK]><![endif]--><?php if($pagamento->igreja->logo): ?>
                                                        <img src="<?php echo e(Storage::disk('supabase')->url($pagamento->igreja->logo)); ?>"
                                                        class="me-3 rounded-circle border"
                                                        alt="Logo <?php echo e($pagamento->igreja->nome); ?>"
                                                        style="width: 40px; height: 40px; object-fit: cover;">
                                                    <?php else: ?>
                                                        <div class="user-avatar bg-primary text-white me-3">
                                                            <?php echo e(strtoupper(substr($pagamento->igreja->nome ?? 'N', 0, 2))); ?>
                                                    ...
                                                    <div>
                                                        <h6 class="mb-0"><?php echo e(Str::limit($pagamento->igreja->nome, 18, '')); ?></h6>
                                                        <small class="text-muted"><?php echo e($pagamento->igreja->sigla); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge bg-info"><?php echo e($pagamento->pacote_nome); ?></span>
                                                <!--[if BLOCK]><![endif]--><?php if($pagamento->is_vitalicio): ?>
                                                    <small class="text-success d-block">Vitalício</small>
                                                <?php else: ?>
                                                    <small class="text-primary d-block"><?php echo e($pagamento->duracao_meses); ?> meses</small>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </td>
                                            <td>
                                                <strong class="text-success"><?php echo e($pagamento->getValorFormatado()); ?></strong>
                                            </td>
                                            <td>
                                                <div>
                                                    <div><?php echo e($pagamento->getDataPagamentoFormatada()); ?></div>
                                                    <small class="text-muted"><?php echo e($pagamento->data_pagamento->diffForHumans()); ?></small>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge bg-secondary"><?php echo e($pagamento->getMetodoFormatado()); ?></span>
                                                <!--[if BLOCK]><![endif]--><?php if($pagamento->temComprovativo()): ?>
                                                    <i class="fas fa-paperclip text-success ms-1"
                                                       ...
                                                       wire:click="visualizarComprovativo('<?php echo e($pagamento->id); ?>')"></i>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </td>
                                            <td>
                                                <span class="badge bg-<?php echo e($pagamento->getStatusBadgeClass()); ?> text-light">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-success btn-sm"
                                                            wire:click="selecionarPagamento('<?php echo e($pagamento->id); ?>')"
                                                            title="Aprovar Pagamento"
                                                            <?php if(!$pagamento->temComprovativo()): ?>
                                                                disabled
                                                            <?php endif; ?>>
                                                        <i class="fas fa-check"></i> Aprovar
                                                    </button>
                                                    <button class="btn btn-danger btn-sm"
                                                            wire:click="selecionarPagamentoRejeicao('<?php echo e($pagamento->id); ?>')"
            ...
            Livewire.on('mostrarModalRejeicao', (data) => {
                ...
                window.subscribersModalInstances.rejection = Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').rejeitarPagamento();
            ...
            Livewire.on('mostrarModalConfirmacao', (data) => {
                ...
                window.subscribersModalInstances.confirmation = Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').iniciarProcessamento();
                        return false; // Impede fechamento automático
                    },
                    allowOutsideClick: false,
                    allowEscapeKey: false,
            ...
            Livewire.on('processando', () => {
                ...
                window.subscribersModalInstances.processing = Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        setTimeout(() => {
                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').confirmarPagamento();
                        }, 10000);
                    },
                    didClose: () => {
                        window.subscribersModalInstances.processing = null;
...
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/billings/subscribers.blade.php ENDPATH**/ ?>