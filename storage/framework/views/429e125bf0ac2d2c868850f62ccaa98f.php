<div>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('system/css/dashboard.css')); ?>">
    <div class="row">
             ...
             <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0" id="receita-value"><?php echo e(number_format($receitaMesAtual, 2, ',', '.')); ?> Kz</h4>
              ...
              <div class="card enhanced-card">
                 <div class="card-body">
                     <div class="d-flex align-items-center justify-content-between">
                         ...
                         <div class="ms-3">
                             <h4 class="mb-0"><?php echo e($novosContratos); ?></h4>
             ...
             <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($igrejasAtivas); ?></h4>
             ...
             <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($churn); ?>%</h4>
              ...
              <div class="card enhanced-card">
                 <div class="card-body">
                     <div class="d-flex align-items-center justify-content-between">
                         ...
                         <div class="ms-3">
                             <h4 class="mb-0"><?php echo e($assinaturasVencendo7d); ?></h4>
             ...
             <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e(number_format($receitaRecorrenteMensal, 0, ',', '.')); ?> Kz</h4>
             ...
             <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($falhasPagamentoMes); ?></h4>
             ...
             <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($taxaRenovacao); ?>%</h4>
            ...
            <div class="card" data-aos="fade-up" data-aos-delay="800" wire:ignore>
                <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                    <div class="header-title">
                        <h4 class="card-title">
                            <span><?php echo e(number_format($receitaMesAtual, 2, ',', '.')); ?></span> Kz
                        </h4>
                        <p class="mb-0">Vendas Brutas (<?php echo e(ucfirst($periodoSelecionado)); ?>)</p>
                    </div>
                    <div class="dropdown">
                        <a href="#" class="text-gray dropdown-toggle" id="dropdownMenuButton22" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo e(ucfirst($periodoSelecionado)); ?>
                ...
                <div class="flex-wrap card-header d-flex justify-content-between">
                    <div class="header-title">
                        ...
                        <p class="mb-0">
                            ...
                            <span><?php echo e(count($enterpriseClients)); ?></span> novas este mês
                        </p>
                    </div>
                </div>
                <div class="p-0 card-body">
                    <div class="mt-4 table-responsive">
                        <table id="basic-table" class="table mb-0 table-striped" role="grid">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $enterpriseClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded bg-info text-light-subtle img-fluid avatar-40 me-3" src="../assets/images/shapes/01.png" alt="profile">
                                            <h6><?php echo e($client->igreja->nome ?? 'Igreja'); ?></h6>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="iq-media-group iq-media-group-1">
                                            <span class="icon iq-icon-box-3 rounded-pill"><?php echo e($client->igreja->contacto ?? '-'); ?></span>
                                        </div>
                                    </td>
                                    <td><?php echo e(number_format($client->total, 0, ',', '.')); ?></td>
                                    <td>
                                        <div class="mb-2 d-flex align-items-center">
                                            <h6><?php echo e($client->percentual ?? rand(25,100)); ?>%</h6>
                                        </div>
                                        <div class="shadow-none progress bg-info text-light-subtle w-100" style="height: 4px">
                                            <div class="progress-bar bg-info text-light" data-toggle="progress-bar" role="progressbar" aria-valuenow="<?php echo e($client->percentual ?? rand(25,100)); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($client->percentual ?? rand(25,100)); ?>%;"></div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="flex-wrap card-header d-flex justify-content-between">
                    <div class="header-title">
                        ...
                        <p class="mb-0">
                            ...
                            <span><?php echo e(count($igrejasMaisAtivas)); ?></span> igrejas com mais conteúdo
                        </p>
                    </div>
                </div>
                <div class="p-0 card-body">
                    <div class="mt-4 table-responsive">
                        <table class="table mb-0 table-striped" role="grid">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $igrejasMaisAtivas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $igreja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded bg-success-subtle img-fluid avatar-40 me-3" src="../assets/images/shapes/01.png" alt="profile">
                                            <h6><?php echo e($igreja->nome ?? 'Igreja'); ?></h6>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="iq-media-group iq-media-group-1">
                                            <span class="icon iq-icon-box-3 rounded-pill"><?php echo e($igreja->contacto ?? '-'); ?></span>
                                        </div>
                                    </td>
                                    <td><?php echo e(number_format($igreja->total_conteudo ?? 0, 0, ',', '.')); ?></td>
                                    <td>
                ...
                <div class="flex-wrap card-header d-flex justify-content-between">
                    <div class="header-title">
                        ...
                        <p class="mb-0">
                            ...
                            <span><?php echo e(count($topIgrejasEngajamento)); ?></span> igrejas com mais pontos
                        </p>
                    </div>
                </div>
                <div class="p-0 card-body">
                    <div class="mt-4 table-responsive">
                        <table class="table mb-0 table-striped" role="grid">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topIgrejasEngajamento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $engajamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded bg-warning-subtle img-fluid avatar-40 me-3" src="../assets/images/shapes/01.png" alt="profile">
                                            <h6><?php echo e($engajamento->igreja->nome ?? 'Igreja'); ?></h6>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="iq-media-group iq-media-group-1">
                                            <span class="icon iq-icon-box-3 rounded-pill"><?php echo e($engajamento->igreja->contacto ?? '-'); ?></span>
                                        </div>
                                    </td>
                                    <td><?php echo e(number_format($engajamento->total_pontos ?? 0, 0, ',', '.')); ?></td>
                                    <td>
                ...
                <div class="flex-wrap card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <a href="#" class="text-gray dropdown-toggle" id="dropdownPerformancePacotes" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo e(ucfirst($periodoPerformancePacotes)); ?>
                ...
                <div class="card-body">
                    <div class="flex-wrap d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-grid gap col-md-4 col-lg-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $performancePacotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-3">
                                    <span class="text-gray"><?php echo e($pacote['label'] ?? 'Pacote'); ?></span>
                                    <h6><?php echo e(number_format($pacote['total'], 0, ',', '.')); ?></h6>
                                </div>
                            </div>
                ...
                <div class="flex-wrap card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <a href="#" class="text-gray dropdown-toggle" id="dropdownCrescimentoUsuarios" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo e(ucfirst($periodoCrescimentoUsuarios)); ?>
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <a href="#" class="text-gray dropdown-toggle" id="dropdownMetodosPagamento" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo e(ucfirst($periodoMetodosPagamento)); ?>
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <a href="#" class="text-gray dropdown-toggle" id="dropdownDistribuicaoGeografica" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo e(ucfirst($periodoDistribuicaoGeografica)); ?>
        ...
        <div class="col-md-12 col-xl-6">
            <div class="card" data-aos="fade-up" data-aos-delay="1400" wire:ignore>
                <div class="card-header d-flex justify-content-between">
                    ...
                    <span class="badge bg-warning m-2"><h6 class="m-1 mt-1 text-light"><?php echo e(count($assinaturasVencendoLista)); ?></h6></span>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $assinaturasVencendoLista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assinatura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td>
                                        <span class="badge bg-info text-light"><?php echo e($assinatura->pacote->nome ?? 'Pacote'); ?></span>
                                    </td>
                                    <td>
                                        <div>
                                            <small class="text-muted"><?php echo e($assinatura->data_fim ? $assinatura->data_fim->format('d/m/Y') : '-'); ?></small><br>
                                            <small class="text-danger"><?php echo e($assinatura->data_fim ? $assinatura->data_fim->diffForHumans() : '-'); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <?php
        ...
        <div class="col-md-12 col-xl-6">
            <div class="card" data-aos="fade-up" data-aos-delay="1500" wire:ignore>
                <div class="card-header d-flex justify-content-between">
                    ...
                    <span class="badge bg-danger m-2"><h6 class="m-1 mt-1 text-light"><?php echo e(count($falhasPagamentoLista)); ?></h6></span>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $falhasPagamentoLista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $falha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-32 me-2 bg-soft-danger rounded">
                                                <span class="avatar-title"><?php echo e(substr($falha->igreja->nome ?? 'I', 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <h6 class="mb-0"><?php echo e($falha->igreja->nome ?? 'Igreja'); ?></h6>
                                                <small class="text-muted"><?php echo e($falha->igreja->nif ?? '-'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <small class="text-muted"><?php echo e(Str::limit($falha->motivo, 30)); ?></small>
                                    </td>
                                    <td>
                                        <div>
                                            <small class="text-muted"><?php echo e($falha->data ? $falha->data->format('d/m/Y') : '-'); ?></small><br>
                                            <small class="text-danger"><?php echo e($falha->data ? $falha->data->diffForHumans() : '-'); ?></small>
                                        </div>
                                    </td>
                                    <td>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $logsAssinaturasRecentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-32 me-2 bg-soft-secondary rounded">
                                                <span class="avatar-title"><?php echo e(substr($log->igreja->nome ?? 'I', 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <h6 class="mb-0"><?php echo e($log->igreja->nome ?? 'Igreja'); ?></h6>
                                                <small class="text-muted"><?php echo e($log->igreja->nif ?? '-'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <!--[if BLOCK]><![endif]--><?php if($log->pacote): ?>
                                            <span class="badge bg-secondary"><?php echo e($log->pacote->nome); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="badge bg-<?php echo e($acaoClass); ?>"><?php echo e(ucfirst($log->acao)); ?></span>
                                    </td>
                                    <td>
                                        <small class="text-muted"><?php echo e(Str::limit($log->descricao ?? 'Sem descrição', 40)); ?></small>
                                    </td>
                                    <td>
                                        <div>
                                            <small class="text-muted"><?php echo e($log->data_acao ? $log->data_acao->format('d/m/Y H:i') : '-'); ?></small><br>
                                            <small class="text-muted"><?php echo e($log->data_acao ? $log->data_acao->diffForHumans() : '-'); ?></small>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="col-md-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1700" wire:ignore>
                <div class="card-header d-flex justify-content-between">
                    ...
                    <span class="badge bg-danger m-2"><h6 class="m-1 mt-1 text-light"><?php echo e(count($igrejasInativasLista)); ?></h6></span>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $igrejasInativasLista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $igreja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-32 me-2 bg-soft-danger rounded">
                                                <span class="avatar-title"><?php echo e(substr($igreja->nome ?? 'I', 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <h6 class="mb-0"><?php echo e($igreja->nome ?? 'Igreja'); ?></h6>
                                                <small class="text-muted"><?php echo e($igreja->nif ?? '-'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <!--[if BLOCK]><![endif]--><?php if($igreja->assinaturaAtual): ?>
                                            <!--[if BLOCK]><![endif]--><?php if($igreja->assinaturaAtual->status === 'Ativo'): ?>
                                                <span class="badge bg-success">Ativa</span>
                                            <?php elseif($igreja->assinaturaAtual->status === 'Expirado'): ?>
                                                <span class="badge bg-danger">Expirada</span>
                                            <?php else: ?>
                                                <span class="badge bg-warning"><?php echo e($igreja->assinaturaAtual->status); ?></span>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <?php else: ?>
...
<script  data-navigate-once>
    ...
    document.addEventListener('livewire:navigated', () => {
        ...
        const chartData = <?php echo json_encode($this->getChartData(), 15, 512) ?>;
        dashboardManager.init(chartData);
    });
</script>
<?php $__env->stopPush(); ?>

<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/super-admin/dashboard.blade.php ENDPATH**/ ?>