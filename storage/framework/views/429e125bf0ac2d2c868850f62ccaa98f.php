                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="shadow-none progress bg-primary-subtle w-100" style="height: 4px">
                                            <div class="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="<?php echo e($client->percentual ?? rand(25,100)); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($client->percentual ?? rand(25,100)); ?>%;"></div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-info"><?php echo e($assinatura->pacote->nome ?? 'Pacote'); ?></span>
                                    </td>
                                    <td>
                                        <div>
