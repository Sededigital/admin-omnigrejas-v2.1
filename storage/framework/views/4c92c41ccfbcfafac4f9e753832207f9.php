<div>
    <div class="container-fluid p-4">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                        <div class="btn-group" role="group">
                            <a href="<?php echo e(route('churches.alliance.alliance.my')); ?>" wire:navigate class="btn btn-outline-primary btn-md">
                                <i class="fas fa-star me-2"></i>Gerenciar Minhas Alianças
                            </a>
                            <!--[if BLOCK]><![endif]--><?php if(!$showMyAlliances): ?>
            ...
            <div class="col-12">
                <ul class="nav nav-pills nav-fill" id="allianceTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link <?php echo e($showMyAlliances ? 'active' : ''); ?>"
                                wire:click="mostrarMinhasAliancas"
                                type="button">
                            <i class="fas fa-star me-2"></i>Participando (<?php echo e(count($minhasAliancas)); ?>)
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link <?php echo e(!$showMyAlliances ? 'active' : ''); ?>"
                ...
                <div class="card text-center card-hover border border-primary metric-card">
                    <div class="card-body">
                        ...
                        <div class="fw-bold h4 mb-1 text-primary">
                            <!--[if BLOCK]><![endif]--><?php if($showMyAlliances): ?>
                                <?php echo e(count($minhasAliancas)); ?>

                            <?php elseif($showCompatibleOnly): ?>
                                <?php echo e(count($compatibleAlliances)); ?>

                            <?php else: ?>
                                <?php echo e($aliancas->total()); ?>
            ...
            <div class="col-6 col-lg-3">
                <div class="card text-center card-hover border border-success metric-card">
                    <div class="card-body">
                        ...
                        <div class="fw-bold h4 mb-1 text-success"><?php echo e(count($minhasAliancas)); ?></div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card text-center card-hover border border-info metric-card">
                    <div class="card-body">
                        ...
                        <div class="fw-bold h4 mb-1 text-info"><?php echo e(count($compatibleAlliances)); ?></div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card text-center card-hover border border-warning metric-card">
                    <div class="card-body">
                        ...
                        <div class="fw-bold h4 mb-1 text-warning"><?php echo e($categorias->count()); ?></div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        <!--[if BLOCK]><![endif]--><?php if($showCompatibleOnly): ?>
        ...
        <!-- Spinner de Busca -->
        <!--[if BLOCK]><![endif]--><?php if($isSearching): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($showCompatibleOnly && !$isSearching && empty($compatibleAlliances)): ?>
        ...
        <!-- Lista de Alianças -->
        <div class="row g-4">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $showMyAlliances ? $minhasAliancas : ($showCompatibleOnly && !empty($compatibleAlliances) ? $compatibleAlliances : $aliancas); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alianca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
                ...
                <div class="card card-hover h-100 alliance-card">
                        ...
                        <div class="d-flex justify-content-between align-items-center m-2">
                            <div>
                                <h6 class="card-title mb-0">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($alianca->sigla): ?>
                                        <small class="text-muted">(<?php echo e($alianca->sigla); ?>)</small>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </h6>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if(!$showMyAlliances): ?>
                            <span class="badge bg-<?php echo e(match($alianca->status) {
                                    'aprovada' => 'success',
                                ...
                                <?php echo e(match($alianca->status) {
                                        'aprovada' => 'Ativa',
                            ...
                            <?php else: ?>
                                <!--[if BLOCK]><![endif]--><?php if($hasInactiveParticipation): ?>
                    ...
                    <div class="card-body">
                        <p class="card-text text-muted small mb-3">
                            <?php echo e(Str::limit($alianca->descricao, 100)); ?>
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-6">
                                ...
                                <span class="badge bg-light text-dark">
                                    <i class="fas fa-tag me-1"></i><?php echo e($alianca->categoria->nome ?? 'Não definida'); ?>
                            ...
                            <div class="col-6">
                                ...
                                <span class="fw-semibold text-primary">
                                    <i class="fas fa-users me-1"></i><?php echo e($alianca->aderentes_count); ?>
                        ...
                        <div class="mb-3">
                            <!--[if BLOCK]><![endif]--><?php if($hasInactiveParticipation): ?>
                                ...
                                <span class="text-warning">
                                    ...
                                    <?php echo e($participacao ? $participacao->data_desligamento->format('d/m/Y') : 'N/A'); ?>
                            ...
                            <?php else: ?>
                                ...
                                <span class="text-dark">
                                    ...
                                    <?php echo e($participacao ? $participacao->data_adesao->format('d/m/Y') : 'N/A'); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-dark">
                                <i class="fas fa-user me-1"></i><?php echo e($alianca->criador->name ?? 'Sistema'); ?>
                    ...
                    <div class="card-footer bg-transparent">
                        <div class="d-flex gap-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($showMyAlliances && $isParticipating): ?>
                                <!-- Botões apenas para alianças com participação ATIVA -->
                                <div class="d-flex gap-2 flex-wrap">
                                    <button class="btn btn-outline-info btn-sm"
                                            data-bs-toggle="modal"
                                            data-bs-target="#leadersModal"
                                            wire:click="$set('selectedAliancaId', <?php echo e($alianca->id); ?>)">
                                        <i class="fas fa-users me-1"></i>Ver Líderes
                                    </button>
                                    <a href="<?php echo e(route('churches.alliance.community', $alianca->id)); ?>" wire:navigate class="btn btn-outline-success btn-sm">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($canExit): ?>
                                    <button class="btn btn-danger btn-sm"
                                            data-bs-toggle="modal"
                                            data-bs-target="#exitAllianceModal"
                                            wire:click="solicitarSairDaAlianca(<?php echo e($alianca->id); ?>)">
                                        <i class="fas fa-sign-out-alt me-1"></i>Sair
                                    </button>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            <?php elseif($showMyAlliances && $hasInactiveParticipation): ?>
                                <!-- Botões para alianças com participação INATIVA (criadores que saíram) -->
                                <button class="btn btn-outline-primary btn-sm flex-fill"
                                        wire:click="solicitarEntrarNaAlianca(<?php echo e($alianca->id); ?>)"
                            ...
                            <?php elseif($hasInactiveParticipation || in_array($alianca->status, ['aprovada', 'pronta_aprovacao', 'rascunho'])): ?>
                    ...
                    <div class="card-body text-center py-5">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($showMyAlliances): ?>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                <a href="<?php echo e(route('churches.alliance.alliance.my')); ?>" wire:navigate class="btn btn-outline-primary">
                        ...
                        <?php else: ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($search || $categoriaFilter || $showCompatibleOnly): ?>
        ...
        <div class="mt-4 text-center text-muted">
            <small>Mostrando <?php echo e(count($minhasAliancas)); ?> aliança(s) da sua igreja</small>
        </div>
        <?php elseif(!$showCompatibleOnly && $aliancas->hasPages()): ?>
        <div class="mt-4">
            <?php echo e($aliancas->links()); ?>

            <div class="text-center text-muted mt-2">
                <small>Mostrando <?php echo e($aliancas->firstItem()); ?>-<?php echo e($aliancas->lastItem()); ?> de <?php echo e($aliancas->total()); ?> alianças</small>
            </div>
        </div>
        <?php elseif($showCompatibleOnly && !empty($compatibleAlliances)): ?>
        <div class="mt-4 text-center text-muted">
            <small>Mostrando <?php echo e(count($compatibleAlliances)); ?> aliança(s) compatível(is) encontrada(s)</small>
        </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if($selectedAlianca): ?>
                        <div class="text-center mb-4">
                            <i class="fas fa-handshake text-primary" style="font-size: 3rem;"></i>
                        </div>
                        <h6 class="fw-bold text-center mb-3"><?php echo e($selectedAlianca->nome); ?></h6>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" wire:model="novoLiderId">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($this->membrosDisponiveis): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->membrosDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($membro->id); ?>">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if($selectedAlianca): ?>
                        <div class="alert alert-warning">
                            ...
                            <strong>Atenção:</strong> Ao sair da aliança "<?php echo e($selectedAlianca->nome); ?>", todos os líderes da sua igreja serão removidos automaticamente.
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    <!--[if BLOCK]><![endif]--><?php if($selectedAliancaId): ?>
                        <?php
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($aliancaSelecionada): ?>
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-3">
                                    <i class="fas fa-handshake text-primary me-2 fs-5"></i>
                                    <h6 class="mb-0 text-primary fw-bold"><?php echo e($aliancaSelecionada->nome); ?></h6>
                                    <span class="badge bg-primary ms-2">
                                        <?php echo e($lideres->count()); ?> líder<?php echo e($lideres->count() !== 1 ? 'es' : ''); ?>

                                    </span>
                                </div>

                                <!--[if BLOCK]><![endif]--><?php if($lideres->count() > 0): ?>
                                    <div class="row g-3">
                                                ...
                                                <div class="card border-primary h-100 shadow-sm">
                                                    <div class="card-body text-center">
                                                        <div class="position-relative mb-3">
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php if($lider->membro->igreja_id === $igreja->id): ?>
                                                        ...
                                                        <h6 class="mb-1 fw-bold"><?php echo e($lider->membro->user->name); ?></h6>
                                                        <p class="text-muted mb-2 small"><?php echo e(ucfirst($lider->cargo_na_alianca)); ?></p>

                                                        <div class="row g-2 mb-2">
                                                            <div class="col-6">
                                                                <small class="text-muted d-block">Igreja</small>
                                                                <small class="fw-semibold"><?php echo e($lider->membro->igreja->nome ?? 'N/A'); ?></small>
                                                            </div>
                                                            <div class="col-6">
                                                                <small class="text-muted d-block">Adesão</small>
                                                                <small class="fw-semibold"><?php echo e($lider->data_adesao->format('d/m/Y')); ?></small>
                                                            </div>
                                                        </div>

                                                        <!--[if BLOCK]><![endif]--><?php if($lider->membro->igreja_id === $igreja->id): ?>
                                                            <!--[if BLOCK]><![endif]--><?php if($lider->membro->user_id === auth()->id()): ?>
                                                                <button class="btn btn-outline-warning btn-sm w-100"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#confirmActionModal"
                                                                        wire:click="$set('selectedLiderId', <?php echo e($lider->id); ?>)">
    ...
    <div class="modal fade" id="confirmActionModal" tabindex="-1" aria-labelledby="confirmActionModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if($selectedLiderId): ?>
                        <?php
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($liderSelecionado): ?>
                            <div class="text-center mb-4">
                                <!--[if BLOCK]><![endif]--><?php if($isProprioUsuario): ?>
                            ...
                            <div class="card border-light mb-3">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="mb-1"><?php echo e($liderSelecionado->membro->user->name); ?></h6>
                                    <p class="text-muted small mb-0"><?php echo e(ucfirst($liderSelecionado->cargo_na_alianca)); ?></p>
                                </div>
                            </div>
                            ...
                            <p class="text-muted mb-4">
                                ...
                                <?php else: ?>
                                    Tem certeza que deseja <strong>remover</strong> <?php echo e($liderSelecionado->membro->user->name); ?> da aliança?
                                    Esta ação não pode ser desfeita.
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </p>
    ...
    <script src="<?php echo e(asset('system/js/alliance.js')); ?>" data-navigate-once></script>

</div>
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/church/alliance/alliance-church.blade.php ENDPATH**/ ?>