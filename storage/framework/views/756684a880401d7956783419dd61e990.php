    ...
    <div class="sidebar-body pt-0" style="overflow-y: auto; max-height: calc(100vh - 120px);" wire:ignore.self>
        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/')); ?>" wire:navigate wire:current="active">
                        <i class="icon">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('geral/list-users')); ?>" wire:navigate wire:current='active'>
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/church')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo e(url('admin/assignatures/calendar')); ?>" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('admin/assignatures/subscribers')); ?>" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('admin/assignatures/trial-requests')); ?>" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('admin/assignatures/assinaturas-historico')); ?>" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(url('admin/assignatures/assinaturas-atuais')); ?>" wire:navigate wire:current="active">
                             <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo e(url('admin/assignatures/igrejas-assinadas')); ?>" wire:navigate wire:current="active">
                             <i class="icon">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><hr class="hr-horizontal"></li>
                 ...
                 <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(url('admin/assignatures/pagamentos')); ?>" wire:navigate wire:current="active">
                             <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M3 3h18c1.1 0 2 .9 2 2v14c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2z" fill="currentColor"/>
                                    <path d="M7 8h10v2H7V8zm0 4h10v2H7v-2zm0 4h7v2H7v-2z" fill="currentColor"/>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/pacotes')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/modulos')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/pacote-permissoes')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/cupons')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/logs')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/notifications')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/alertas')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/recursos-bloqueados')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/pacote-recursos')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(url('admin/assignatures/pacote-niveis')); ?>" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
...
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/components/layouts/sidebar/super-admin-sidebar.blade.php ENDPATH**/ ?>