        ...
        <div class="card-body p-5">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-4">
                        <!--[if BLOCK]><![endif]--><?php if($diasRestantes === 1): ?>
                            Amanhã será o último dia do seu período de teste gratuito do <strong><?php echo e(config('app.name')); ?></strong>.
                        <?php else: ?>
                            Faltam apenas <strong><?php echo e($diasRestantes); ?> dias</strong> para o fim do seu período de teste gratuito do <strong><?php echo e(config('app.name')); ?></strong>.
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </p>

                    <div class="row g-4">
                        <div class="col-auto text-center">
                            <div class="h4 mb-1"><?php echo e($diasRestantes); ?></div>
                        ...
                        <div class="col-auto text-center border-start border-white border-opacity-25 ps-4">
                            <div class="h4 mb-1"><?php echo e($dataExpiracao); ?></div>
                            <div class="small opacity-75">Data de Expiração</div>
                        </div>
                        <div class="col-auto text-center border-start border-white border-opacity-25 ps-4">
                            <div class="h4 mb-1"><?php echo e($igrejaNome); ?></div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="trial-summary">
                        <div class="summary-item mb-3">
                            ...
                            <div class="summary-value fw-bold text-primary"><?php echo e($nomeUsuario); ?>!</div>
                        </div>

                        <div class="summary-item mb-3">
                            <div class="summary-label">Igreja:</div>
                            <div class="summary-value"><?php echo e($igrejaNome); ?></div>
                        </div>

                        <div class="summary-item mb-3">
                            <div class="summary-label">Data de Expiração:</div>
                            <div class="summary-value text-danger fw-bold"><?php echo e($dataExpiracao); ?></div>
                        </div>

                        <div class="summary-item mb-3">
                            <div class="summary-label">Dias Restantes:</div>
                            <div class="summary-value text-warning fw-bold"><?php echo e($diasRestantes); ?></div>
                        </div>
    ...
    <div class="card cta-gradient text-white border-0 shadow-lg">
        <div class="card-body p-5 text-center">
            ...
            <p class="lead mb-4 fs-5">
                Faça upgrade agora e continue aproveitando todas as funcionalidades do <?php echo e(config('app.name')); ?>.
            </p>

            <div class="d-flex justify-content-center gap-3 flex-wrap mt-4">
                <a href="<?php echo e(route('ecommerce.subscription.upgrade')); ?>" class="btn btn-light btn-lg px-4 fw-bold shadow-sm">
                    <i class="fas fa-rocket me-2"></i>Fazer Upgrade Agora
                </a>
                <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-light btn-lg px-4 fw-bold shadow-sm">
                    <i class="fas fa-home me-2"></i>Ir para Dashboard
                </a>
                <a href="<?php echo e(route('ecommerce.contact')); ?>" class="btn btn-success btn-lg px-4 fw-bold shadow-sm">
                    <i class="fas fa-envelope me-2"></i>Falar com Suporte
                </a>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/ecommerce/trial/expirando.blade.php ENDPATH**/ ?>