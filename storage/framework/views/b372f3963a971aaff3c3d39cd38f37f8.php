        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-light border-bottom">
                <h5 class="modal-title fw-bold" id="memberModalLabel">
                    ...
                    <span id="modal-title"><?php echo e($editingMember ? 'Editar Membro' : 'Cadastrar Novo Membro'); ?></span>
                </h5>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text"  autocomplete="new-password"
                                               class="form-control date_flatpicker <?php $__errorArgs = ['data_nascimento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               data-max-date="<?php echo e(date('Y')); ?>-12-31"
                                               autocomplete="off"
                                               readonly
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text"  autocomplete="new-password"
                                               class="form-control date_flatpicker <?php $__errorArgs = ['data_entrada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['data_entrada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="col-12">
                                    <div class="alert alert-light border">
                                        ...
                                        <span class="text-muted">
                                            <?php echo e($editingMember ? 'Editando Membro' : 'Novo Membro'); ?>
            ...
            <div class="modal-footer border-top bg-light">
                ...
                <button type="button" class="btn btn-primary" wire:click="saveMember" wire:loading.attr="disabled">
                    <span wire:loading.remove wire:target="saveMember">
                        <i class="fas fa-save me-1"></i><?php echo e($editingMember ? 'Atualizar Membro' : 'Salvar Membro'); ?>

                    </span>
                    <span wire:loading wire:target="saveMember">
                        <i class="fas fa-spinner fa-spin me-1"></i><?php echo e($editingMember ? 'Atualizando...' : 'Salvando...'); ?>
...
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/church/members/modals/member-modal.blade.php ENDPATH**/ ?>