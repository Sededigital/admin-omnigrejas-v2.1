<div>
                ...
                <div class="col-md-12">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($igreja): ?>
                                <h2 class="text-decoration-underline"><?php echo e($igreja->nome); ?></h2>
            ...
            <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e(number_format($receitasMes, 2, ',', '.')); ?> Kz</h4>
            ...
            <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($totalMembros); ?></h4>
            ...
            <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($pedidosOracao); ?></h4>
            ...
            <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($eventosAtivos); ?></h4>
            ...
            <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e($cursosAtivos); ?></h4>
            ...
            <div class="card enhanced-card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3">
                            <h4 class="mb-0"><?php echo e(number_format($engajamentoTotal, 0, ',', '.')); ?></h4>
            ...
            <div class="card" data-aos="fade-up" data-aos-delay="1200" wire:ignore>
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="badge bg-primary me-2"><?php echo e(count($this->graficoDistribuicaoGeografica)); ?> regiões</span>
                        <span class="badge bg-success"><?php echo e(array_sum(array_column($this->graficoDistribuicaoGeografica, 'total'))); ?> membros mapeados</span>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="border-start ps-4">
                                ...
                                <div class="mb-3">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = array_slice($this->graficoDistribuicaoGeografica, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $regiao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <small class="text-truncate" style="max-width: 150px;" title="<?php echo e($regiao['localizacao']); ?>">
                                                <?php echo e(Str::limit($regiao['localizacao'], 20)); ?>
                                ...
                                <div class="mb-2">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <small class="fw-semibold">
                                            <?php echo e($this->estatisticasGeograficas['regiao_mais_populosa'] ?? 'N/A'); ?>

                                        </small>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <small class="text-muted">Cobertura geográfica</small>
                                        <small class="fw-semibold"><?php echo e($this->estatisticasGeograficas['cobertura_geografica'] ?? 0); ?> regiões</small>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <small class="text-muted">Média por região</small>
                                        <small class="fw-semibold"><?php echo e($this->estatisticasGeograficas['media_por_regiao'] ?? 0); ?> membros</small>
                                    </div>
                                </div>
    ...
    <?php echo $__env->make('admin.modals.distribuicao-geografica-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
[$__name, $__params] = $__split('sms.sms-manager');

$__html = app('livewire')->mount($__name, $__params, 'lw-470194858-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>