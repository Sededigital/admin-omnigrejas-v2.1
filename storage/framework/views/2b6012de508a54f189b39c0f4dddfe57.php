...
<div class="hero-section text-center py-5 mb-5">
    <div class="container">
        ...
        <h1 class="display-4 fw-bold text-white mb-3"><?php echo e(config('app.name')); ?></h1>
        <p class="lead text-white-50 fs-4">Teste Gratuito por 10 Dias</p>
    </div>
</div>


<!--[if BLOCK]><![endif]--><?php if($mostrar_sucesso): ?>
                ...
                <div class="card-body p-5 text-center bg-success text-white rounded-3">
                    ...
                    <div class="trial-info bg-white text-dark p-4 rounded-3 mb-4">
                        ...
                        <div class="row text-start">
                            <div class="col-md-6">
                                <p class="mb-2"><strong>Nome:</strong> <?php echo e($dados_trial['usuario']['nome']); ?></p>
                                <p class="mb-2"><strong>Email:</strong> <?php echo e($dados_trial['usuario']['email']); ?></p>
                                <p class="mb-2"><strong>Igreja:</strong> <?php echo e($dados_trial['igreja']['nome']); ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2"><strong>Período Solicitado:</strong> <span class="text-primary fw-bold"><?php echo e($dados_trial['periodo']['dias']); ?> dias</span></p>
                                <p class="mb-2"><strong>Status:</strong> <span class="badge bg-warning">Aguardando Aprovação</span></p>
                                <p class="mb-2"><strong>Data da Solicitação:</strong> <?php echo e(now()->format('d/m/Y H:i')); ?></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($errors->has('geral')): ?>
                        <div class="alert alert-danger border-0 shadow-sm">
                            <i class="fas fa-exclamation-triangle me-2"></i>
                            <?php echo e($errors->first('geral')); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    class="form-control form-control-lg <?php $__errorArgs = ['igreja_nome'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($categoria->nome); ?>"><?php echo e($categoria->nome); ?></option>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['aceitou_termos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</div><?php /**PATH C:\laragon\www\admin-omnigrejas-v2.1\resources\views/ecommerce/trial/solicitar.blade.php ENDPATH**/ ?>