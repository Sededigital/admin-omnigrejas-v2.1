               ...
               <nav class="mb-4">
                   <div class="nav nav-tabs border-bottom-0" id="nav-tab" role="tablist">
                       ...
                       <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-details-tab"
                           ...
                           <i class="fas fa-user-tag text-primary me-1"></i>Função e Status
                       </button>
                   </div>
               </nav>
                       ...
                       <div class="row g-3">
                           ...
                           <div class="col-md-8">
                               <div class="form-floating mb-3">
                                   ...
                                   <label><i class="fas fa-user text-primary me-1"></i>Nome Completo *</label>
                                   @error('name')
                       ...
                       <div class="row g-3">
                           ...
                           <div class="col-12">
                               <div class="form-floating mb-3">
                                   ...
                                   <label><i class="fas fa-user-tag text-primary me-1"></i>Função *</label>
                                   @error('role')
                                       <div class="invalid-feedback">{{ $message }}</div>
                                   @enderror
                               </div>
