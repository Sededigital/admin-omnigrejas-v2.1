                                                    ...
                                                    @if($igrejas)
                                                        <div class="church-selection-container" style="max-height: 400px; overflow-y: auto; border: 1px solid #e3e3e0; border-radius: 8px; padding: 15px;">
                                                            @foreach($igrejas as $igreja)
                                                                <div class="church-card mb-3 p-3 border rounded-lg cursor-pointer transition-all hover:shadow-md"
                                                                     style="border: 2px solid {{ $selectedIgrejaId == $igreja['id'] ? '#007bff' : '#e3e3e0' }} !important; background: {{ $selectedIgrejaId == $igreja['id'] ? '#f8f9ff' : 'white' }};"
                                                                     wire:click="$set('selectedIgrejaId', {{ $igreja['id'] }})">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <div class="d-flex align-items-center mb-1">
                                                                                <h6 class="mb-0 me-2">{{ $igreja['nome'] }}</h6>
                                                                                @if($igreja['sigla'])
                                                                                    <small class="badge bg-secondary">{{ $igreja['sigla'] }}</small>
                                                                                @endif
                                                                            </div>
                                                                            ...
                                                                            <div class="text-muted small">
                                                                                <div>Membro desde: {{ $igreja['membro_desde'] }}</div>
                                                                                @if($igreja['localizacao'])
                                                                                    <div>📍 {{ $igreja['localizacao'] }}</div>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="text-center mt-3">
                                                            <small class="text-muted">
                                                                {{ count($igrejas) }} igreja{{ count($igrejas) > 1 ? 's' : '' }} encontrada{{ count($igrejas) > 1 ? 's' : '' }}
                                                            </small>
                                                        </div>
                                                    @else
                    ...
                    <div class="modal-body py-3">
                        <div id="access-code-content">
                            ...
                            <div class="mb-2">
                                <input
                                    type="password"
                                    class="form-control form-control-lg border-rounded border-primary text-center @error('accessCode') is-invalid @enderror"
