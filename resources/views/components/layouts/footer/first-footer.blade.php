@if(Auth::user()->role == 'admin' || Auth::user()->role == 'pastor' || Auth::user()->role == 'ministro' || Auth::user()->role == 'super_admin')
      {{-- Botão SMS --}}
...
@if($mostrarBotaoLicenca)
<a class="btn btn-fixed-end btn-danger btn-icon btn-dashboard z-3" href="{{ route('ecommerce.home') }}" target="_blank">
      Licença Produto
</a>
@endif
          ...
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-3 grid-cols-2 ">
              ...
              <div class="text-center">
                ...
                <img src="{{ asset('assets/images/settings/light/01.png') }}" alt="color"
                  class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
