    ...
    <div class="sidebar-body pt-0" style="overflow-y: auto; max-height: calc(100vh - 120px); scroll-behavior: smooth;"  wire:ignore.self>
        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}" scroll="false" wire:navigate wire:current="active">
                        <i class="icon">
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-biblia" role="button" aria-expanded="false" aria-controls="sidebar-biblia">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-20">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-biblia" data-bs-parent="#sidebar-menu">
                      <li class="nav-item">
                ...
                {{-- START Gestão Organizacional --}}
                @if(($permissionHelper->hasPermission('gerenciar_corpo_lideranca')  || $permissionHelper->hasPermission('gerenciar_igrejas')
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-gerenciar-organizacional" data-bs-parent="#sidebar-menu">
                        @if($permissionHelper->hasPermission('gerenciar_corpo_lideranca') && $resourceHelper->userCanAccessResource('gerenciar_corpo_lideranca'))
                        <li class="nav-item">
                            <a class="nav-link " href="{{ url('churches/leadership-body') }}" wire:navigate wire:current='active'>
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        @endif
                        @if(($permissionHelper->hasPermission('gerenciar_igrejas') || $permissionHelper->hasPermission('ver_igrejas')) && $resourceHelper->userCanAccessResource('gerenciar_igrejas'))
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ url('/churches/alliance-church') }}" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        @endif
                        @if(($permissionHelper->hasPermission('gerenciar_ministerios') || $permissionHelper->hasPermission('ver_ministerios')) && $resourceHelper->userCanAccessResource('gerenciar_ministerios'))
                        <li class="nav-item">
                        ...
                        @endif
                        @if(($permissionHelper->hasPermission('gerenciar_membros') || $permissionHelper->hasPermission('ver_membros')) && $resourceHelper->userCanAccessResource('gerenciar_membros'))
                        <li class="nav-item">
                        ...
                        @endif
                        @if($permissionHelper->hasPermission('gerenciar_cartoes_membros') && $resourceHelper->userCanAccessResource('gerenciar_cartoes_membros'))
                        <li class="nav-item">
                            <a class="nav-link " href="{{ url('churches/church-member-cards') }}" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                {{-- START EVENTOS & ESCALAS --}}
                @if(($permissionHelper->hasPermission('gerenciar_eventos') || $permissionHelper->hasPermission('gerenciar_escalas')
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-eventos-escalas" data-bs-parent="#sidebar-menu">
                        @if($permissionHelper->hasPermission('gerenciar_eventos') && $resourceHelper->userCanAccessResource('gerenciar_eventos'))
                        <li class="nav-item">
                        ...
                        @endif
                        @if($permissionHelper->hasPermission('gerenciar_escalas') && $resourceHelper->userCanAccessResource('gerenciar_escalas'))
                        <li class="nav-item">
                        ...
                        @endif
                        @if($permissionHelper->hasPermission('gerenciar_cultos') && $resourceHelper->userCanAccessResource('gerenciar_cultos'))
                        <li class="nav-item">
                ...
                @if(($permissionHelper->hasPermission('gerenciar_mapa_talentos') || $permissionHelper->hasPermission('visualizar_mapa_talentos'))
                {{-- Verificar se recursos estão disponíveis no pacote --}}
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_relatorios') || $permissionHelper->hasPermission('visualizar_relatorios'))
                {{-- Verificar se recursos estão disponíveis no pacote --}}
                && $resourceHelper->userCanAccessSection(['gerenciar_relatorios', 'visualizar_relatorios']))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-reports') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @if(($permissionHelper->hasPermission('gerenciar_pedidos_especiais') || $permissionHelper->hasPermission('ver_pedidos') || $permissionHelper->hasPermission('aprovar_pedidos'))
                {{-- Verificar se recursos estão disponíveis no pacote --}}
                && $resourceHelper->userCanAccessSection(['gerenciar_pedidos_especiais', 'ver_pedidos', 'aprovar_pedidos']))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-special-requests') }}" wire:navigate wire:current="active">
                        <i class="icon">
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_estatisticas') || $permissionHelper->hasPermission('visualizar_estatisticas'))
                {{-- Verificar se recursos estão disponíveis no pacote --}}
                && $resourceHelper->userCanAccessSection(['gerenciar_estatisticas', 'visualizar_estatisticas']))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-statistics') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                @if(($permissionHelper->hasPermission('gerenciar_calendario') || $permissionHelper->hasPermission('visualizar_calendario'))
                {{-- Verificar se recursos estão disponíveis no pacote --}}
                ...
                @endif
                {{-- END Gestão Organizacional --}}

                {{-- LINK RESTRITA A MEMBROS DE ALTO PADRÃO --}}
                @if((Auth::user()->role =='admin' || Auth::user()->role =='pastor' || Auth::user()->role =='ministro') && $resourceHelper->userCanAccessResource('gerenciar_controle_acesso'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/rbac-control') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2Z" fill="currentColor"/>
                ...
                {{-- START  Discipulado e Educação Cristã --}}
                @if(($permissionHelper->hasPermission('gerenciar_cursos') || $permissionHelper->hasPermission('ver_cursos')
                ...
                {{-- START GERIR --}}
                @if(($permissionHelper->hasPermission('gerenciar_cursos') || $permissionHelper->hasPermission('ver_cursos') || $permissionHelper->hasPermission('gerenciar_inscricoes')
               || $permissionHelper->hasPermission('inscrever_alunos'))
               && $resourceHelper->userCanAccessSection(['gerenciar_cursos', 'ver_cursos', 'gerenciar_inscricoes', 'inscrever_alunos']))
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-discipulado-gerir" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link "  href="{{ url('churches/church-courses/courses') }}" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        @endif
                        @if($permissionHelper->hasPermission('gerenciar_inscricoes') || $permissionHelper->hasPermission('inscrever_alunos'))
                        <li class="nav-item">
                            <a class="nav-link " href="{{ url('churches/church-courses/registration') }}" wire:navigate wire:current="active">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                @if(($permissionHelper->hasPermission('visualizar_certificados') || $permissionHelper->hasPermission('emitir_certificados'))
                && ($resourceHelper->userCanAccessResource('visualizar_certificados') || $resourceHelper->userCanAccessResource('emitir_certificados')))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-courses/certificates') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                @endif
                {{-- END  Discipulado e Educação Cristã --}}

                {{-- START  Gestão Financeira--}}
                @if(($permissionHelper->hasPermission('gerenciar_financeiro') || $permissionHelper->hasPermission('visualizar_financeiro')
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-gerenciar-financeiro" data-bs-parent="#sidebar-menu">
                        @if(($permissionHelper->hasPermission('gerenciar_financeiro') || $permissionHelper->hasPermission('lancar_movimentos'))
                        ...
                        @endif
                        @if($permissionHelper->hasPermission('visualizar_financeiro') && $resourceHelper->userCanAccessResource('visualizar_financeiro'))
                        <li class="nav-item">
                ...
                @if($permissionHelper->hasPermission('gerenciar_doacoes_online') && $resourceHelper->userCanAccessResource('gerenciar_doacoes_online'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-financial/online-donations') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @endif
                {{-- END Gestão Financeira --}}


                {{-- START social & Comunicação --}}
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-social-comunicacao" data-bs-parent="#sidebar-menu">
                        @if($permissionHelper->hasPermission('gerenciar_posts') && $resourceHelper->userCanAccessResource('gerenciar_posts'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/churches/only-posts') }}" wire:navigate wire:current="active">
                        ...
                        @if($permissionHelper->hasPermission('gerenciar_comunicacoes') && $resourceHelper->userCanAccessResource('gerenciar_comunicacoes'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('churches/alliance-church/community') }}" wire:navigate wire:current="active">
                                    <i class="icon"><svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="8" fill="currentColor"/></svg></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('churches.chat.churches') }}" wire:navigate wire:current="active">
                                <i class="icon"><svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="8" fill="currentColor"/></svg></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('churches/chat/private-chat') }}" wire:navigate wire:current="active">
                                <i class="icon"><svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="8" fill="currentColor"/></svg></i>
                ...
                @endif
                {{-- END social & Comunicação --}}


                {{-- START Voluntariado e Recursos --}}
                @if(($permissionHelper->hasPermission('gerenciar_voluntarios') || $permissionHelper->hasPermission('gerenciar_recursos')
                ...
                @if($permissionHelper->hasPermission('gerenciar_voluntarios') && $resourceHelper->userCanAccessResource('gerenciar_voluntarios'))
                <li class="nav-item">
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_migracao_membros') || $permissionHelper->hasPermission('ver_historico_migracao')
                || $permissionHelper->hasPermission('migrar_membro') || $permissionHelper->hasPermission('aprovar_migracao'))
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-member-migration') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2Z" fill="currentColor"/>
                                <path d="M21 9V7L18.5 7.5L18 6L19.5 4.5L18 3L16.5 4.5L15 4L15.5 1.5H13.5L14 4L12.5 4.5L11 3L9.5 4.5L11 6L10.5 7.5L8 7V9L10.5 8.5L11 10L9.5 11.5L11 13L12.5 11.5L14 12L13.5 14.5H15.5L15 12L16.5 11.5L18 13L19.5 11.5L18 10L18.5 8.5L21 9Z" fill="currentColor"/>
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_vitrine_igrejas') || $permissionHelper->hasPermission('ver_vitrine_igrejas'))
                && ($resourceHelper->userCanAccessResource('gerenciar_vitrine_igrejas') || $resourceHelper->userCanAccessResource('ver_vitrine_igrejas')))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-showcase') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2Z" fill="currentColor"/>
                                <path d="M12 8C15.31 8 18 10.69 18 14V16C18 17.1 17.1 18 16 18H8C6.9 18 6 17.1 6 16V14C6 10.69 8.69 8 12 8Z" fill="currentColor"/>
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_recursos') || $permissionHelper->hasPermission('ver_recursos'))
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_atendimentos_pastorais') || $permissionHelper->hasPermission('ver_atendimentos') || $permissionHelper->hasPermission('gerenciar_atendimentos'))
                ...
                @endif
                {{--  END Voluntariado e Recursos --}}


                {{--  START  Marketplace--}}
                @if(($permissionHelper->hasPermission('gerenciar_produtos') || $permissionHelper->hasPermission('gerenciar_pedidos')
                ...
                @if($permissionHelper->hasPermission('gerenciar_produtos') && $resourceHelper->userCanAccessResource('gerenciar_produtos'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-marketplace/products') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" fill="currentColor"/>
                ...
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_pedidos') || $permissionHelper->hasPermission('ver_pedidos') || $permissionHelper->hasPermission('processar_pedidos'))
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-marketplace/orders') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" fill="currentColor"/>
                                <path d="M8 8h8v2H8V8zm0 4h8v2H8v-2zm0 4h5v2H8v-2z" fill="currentColor"/>
                ...
                @if($permissionHelper->hasPermission('gerenciar_pagamentos') && $resourceHelper->userCanAccessResource('gerenciar_pagamentos'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-marketplace/payments') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" fill="currentColor"/>
                                <path d="M4 8h16v2H4V8zm0 4h16v2H4v-2z" fill="currentColor"/>
                ...
                {{-- START Engajamento & Gamificação --}}
                @if(($permissionHelper->hasPermission('gerenciar_engajamento') || $permissionHelper->hasPermission('ver_engajamento') || $permissionHelper->hasPermission('gerenciar_badges')
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-engajamento" data-bs-parent="#sidebar-menu">
                        @if(($permissionHelper->hasPermission('gerenciar_engajamento') || $permissionHelper->hasPermission('ver_engajamento') || $permissionHelper->hasPermission('gerenciar_badges'))
                        && ($resourceHelper->userCanAccessResource('gerenciar_engajamento') || $resourceHelper->userCanAccessResource('ver_engajamento') || $resourceHelper->userCanAccessResource('gerenciar_badges')))
                        <li class="nav-item"><a class="nav-link" href="{{ url('churches/church-engagement/badges') }}" wire:navigate wire:current='active'>🏅 Badges</a></li>
                        @endif
                        @if(($permissionHelper->hasPermission('gerenciar_engajamento') || $permissionHelper->hasPermission('ver_engajamento') || $permissionHelper->hasPermission('gerenciar_pontos'))
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ url('churches/church-engagement/points') }}" wire:navigate wire:current='active'>⭐ Pontos</a></li>
                        @endif
                        @if(($permissionHelper->hasPermission('gerenciar_engajamento') || $permissionHelper->hasPermission('ver_engajamento') || $permissionHelper->hasPermission('gerenciar_enquetes'))
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ url('churches/church-engagement/polls') }}" wire:navigate  wire:current='active'>📊 Enquetes</a></li>
                        @endif
                    </ul>
                </li>
                ...
                @if($permissionHelper->hasPermission('gerenciar_assinaturas'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('churches/church-subscription') }}" wire:navigate wire:current="active">
                        <i class="icon">
                            <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        @endphp
                        @if($alertsCount > 0)
                            <span class="badge badge-danger right">{{ $alertsCount }}</span>
                        @endif
                    </a>
                </li>
                @endif
                @if(($permissionHelper->hasPermission('gerenciar_definicoes') || $permissionHelper->hasPermission('acessar_definicoes'))
