...
<head>
    ...
    <title>Credenciais de Acesso - {{ config('app.name') }}</title>
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 40px 30px; background-color: #ffffff;">
                            ...
                            <p style="font-size: 16px; color: #374151; margin: 0 0 16px 0; line-height: 1.7;">
                                Sua conta foi criada com sucesso no sistema <strong style="color: #059669;">{{ config('app.name') }}</strong>. Suas credenciais de acesso estão prontas.
                            </p>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 36px; margin-bottom: 36px;">
                                <tr>
                                    <td align="center">
                                        ...
                                        <a href="{{ $loginUrl }}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: white; text-decoration: none; padding: 16px 36px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(5, 150, 105, 0.2); transition: all 0.3s ease;">
                                            Fazer Login Agora
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="font-size: 16px; color: #059669; margin: 0 0 32px 0;">
                                <a href="{{ $loginUrl }}" style="color: #059669; text-decoration: underline;">{{ $loginUrl }}</a>
                            </p>
                            ...
                            <p style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb; color: #6b7280; font-style: italic; font-size: 14px;">
                                Se você não solicitou esta conta ou tem dúvidas, entre em contato conosco.
                            </p>
                            <p style="margin: 0; color: #111827; font-size: 14px;">
                                <strong style="font-weight: 700;">Equipe do {{ config('app.name') }}</strong>
                            </p>
