                    ...
                    <tr>
                        <td class="content-padding" style="padding: 40px 30px; background-color: #ffffff;">
                            ...
                            <p style="font-size: 16px; color: #374151; margin: 0 0 16px 0; line-height: 1.7;">
                                Parabéns! Você foi cadastrado como membro da <strong style="color: #059669;">{{ $igrejaNome }}</strong> em nosso sistema. Suas credenciais de acesso foram criadas com sucesso.
                            </p>
                            ...
                            <p style="margin: 0; color: #111827; font-size: 14px;">
                                <strong style="font-weight: 700;">Equipe da {{ $igrejaNome }}<br>{{ config('app.name') }}</strong>
                            </p>
