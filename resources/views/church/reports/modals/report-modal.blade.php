    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <nav class="mb-4" wire:ignore>
                        <div class="nav nav-tabs border-bottom-0" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-details-tab"
                                ...
                                <i class="fas fa-chart-line text-info me-1"></i>Dados do Culto
                            </button>
                            <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-statistics-tab"
                                ...
                                <i class="fas fa-chart-bar text-info me-1"></i>Estatísticas Detalhadas
                            </button>
                            <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-finance-tab"
                                ...
                                <i class="fas fa-money-bill-wave text-info me-1"></i>Valores Financeiros
                            </button>
                            <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-info-tab"
                                ...
                                <i class="fas fa-info text-info me-1"></i>Informações do Culto
                            </button>
                            <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-evaluation-tab"
                                ...
                                <i class="fas fa-check-circle text-info me-1"></i>Avaliação
                            </button>
                            <button class="nav-link border-0 bg-transparent fw-semibold" id="nav-content-tab"
                                ...
                                <i class="fas fa-file-text text-info me-1"></i>Conteúdo
                            </button>
                        </div>
                    </nav>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-alt text-info me-1"></i>Evento Relacionado</label>
                                        @error('evento_id')
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-church text-info me-1"></i>Culto Padrão</label>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-heading text-info me-1"></i>Título (opcional)</label>
                                        @error('titulo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-day text-info me-1"></i>Data do Relatório *</label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-users text-info me-1"></i>Número de Participantes</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-money-bill-wave text-info me-1"></i>Valor da Oferta (AOA)</label>
                                        @error('valor_oferta')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-user-friends text-info me-1"></i>Número de Visitantes</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-hand-paper text-info me-1"></i>Número de Decisões</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-water text-info me-1"></i>Número de Batismos</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-heart text-info me-1"></i>Número de Conversões</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-handshake text-info me-1"></i>Número de Reconciliações</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-ring text-info me-1"></i>Número de Casamentos</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-cross text-info me-1"></i>Número de Funerais</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-alt text-info me-1"></i>Outros Eventos</label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-coins text-info me-1"></i>Valor dos Dízimos (AOA)</label>
                                        @error('valor_dizimos')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-hand-holding-heart text-info me-1"></i>Valor das Ofertas (AOA)</label>
                                        @error('valor_ofertas')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-gift text-info me-1"></i>Valor das Doações (AOA)</label>
                                        @error('valor_doacoes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-plus-circle text-info me-1"></i>Outros Valores (AOA)</label>
                                        @error('valor_outros')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="alert alert-light border">
                                        ...
                                        <span class="text-muted ms-2">
                                            ...
                                            @if($valor_dizimos) • <span class="text-info fw-bold">Dízimos: {{ number_format($valor_dizimos, 2, ',', '.') }}</span> @endif
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-themeisle text-info me-1"></i>Tema do Culto</label>
                                        @error('tema_culto')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-user-tie text-info me-1"></i>Pregador</label>
                                        @error('pregador')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-user-friends text-info me-1"></i>Pregador Convidado</label>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-book-open text-info me-1"></i>Texto Base</label>
                                        @error('texto_base')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-comment-dots text-info me-1"></i>Resumo da Mensagem</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-week text-info me-1"></i>Tipo de Culto</label>
                                        @error('tipo_culto')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-user-cog text-info me-1"></i>Dirigente</label>
                                        @error('dirigente')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-music text-info me-1"></i>Responsável pela Música</label>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-sticky-note text-info me-1"></i>Observações Gerais</label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-user-check text-info me-1"></i>Avaliado Por</label>
                                        @error('avaliado_por')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        @if($avaliado_por)
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-check text-info me-1"></i>Data da Avaliação</label>
                                ...
                                <div class="col-12">
                                    <div class="alert @if($avaliado_por) alert-success @else alert-info @endif border">
                                        <i class="fas @if($avaliado_por) fa-check-circle @else fa-info-circle @endif text-info me-2"></i>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-file-text text-info me-1"></i>Conteúdo do Relatório *</label>
                                        @error('conteudo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
            ...
            <div class="modal-footer border-top bg-light">
                ...
                <button type="button" class="btn bg-info text-light" wire:click="salvarRelatorio" wire:loading.attr="disabled">
