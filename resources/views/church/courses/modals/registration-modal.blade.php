    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <nav class="mb-4">
                        <div class="nav nav-tabs border-bottom-0" id="nav-tab-registration" role="tablist">
                            <button class="nav-link active border-0 bg-transparent fw-semibold" id="nav-basic-registration-tab"
                                ...
                                <i class="fas fa-info-circle text-info me-1"></i>Informações da Matrícula
                            </button>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-plus text-info me-1"></i>Data Matrícula</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-check text-info me-1"></i>Data Apto</label>
                                        @error('data_apto')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <label class="form-check-label" for="certificado_emitido">
                                            <i class="fas fa-certificate text-info me-1"></i>Certificado Emitido
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fas fa-calendar-alt text-info me-1"></i>Data Certificado</label>
            ...
            <div class="modal-footer border-top bg-light">
                ...
                <button type="button" class="btn bg-info text-light" wire:click="salvarRegistration" wire:loading.attr="disabled">
