                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-body text-center p-4">
                         ...
                         <div class="d-flex justify-content-between text-start mb-2">
                             ...
                             <span class="fw-semibold">{{ $assinaturaAtual->data_inicio->format('d/m/Y') }}</span>
                         </div>
                         @if(!$assinaturaAtual->vitalicio)
                         <div class="d-flex justify-content-between text-start mb-2">
                             <small class="text-muted">Expira:</small>
                             <span class="fw-semibold">{{ $assinaturaAtual->data_fim->format('d/m/Y') }}</span>
                         </div>
                         @endif
                         <div class="d-flex justify-content-between text-start">
                             <small class="text-muted">Tipo:</small>
                             <span class="fw-semibold">{{ $assinaturaAtual->vitalicio ? 'Vitalícia' : 'Periódica' }}</span>
                         </div>
                    </div>
                </div>
