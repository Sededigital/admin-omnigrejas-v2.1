                ...
                <div class="bg-primary" style="background: transparent; height: 320px;">
                    <div class="gradient-bottom">
                        <div class="bottom-text general-zindex">
                            ...
                            <p>Não vai demorar muito até que o erro seja corrigido. Voltaremos em</p>
                            <ul class="countdown d-flex justify-content-center align-items-center list-inline" data-date="Dec 31 2024 20:20:22">
                                <li>
                                    <span data-days>0</span>Dias
                                </li>
                                <li>
                                    <span data-hours>0</span>Horas
                                </li>
                                <li>
                                    <span data-minutes>0</span>Minutos
                                </li>
                                <li>
                                    <span data-seconds>0</span>Segundos
                                </li>
                            </ul>
