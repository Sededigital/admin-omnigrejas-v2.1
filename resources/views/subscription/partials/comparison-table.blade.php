        ...
        <table class="comparison-table">
            <thead>
                <tr class="table-header">
                    ...
                    @foreach($pacotes as $pacote)
                        <th class="plan-column {{ $pacote->isPopular() ? 'popular-plan' : '' }}">
                            <div class="plan-card">
                                @if($pacote->isPopular())
                                ...
                                <div class="plan-name">{{ $pacote->nome }}</div>
                                <div class="plan-price">
                                    <span class="price-amount">{{ $pacote->getPrecoFormatado() }}</span>
                                    <span class="price-period">/mês</span>
                                </div>

                                @if($pacote->preco_vitalicio)
                                    <div class="plan-lifetime">
                                        <small>Ou {{ $pacote->getPrecoVitalicioFormatado() }} vitalício</small>
                                    </div>
                                @endif

                                <div class="plan-trial">
                                    <i class="fas fa-gift text-success"></i>
                                    <span>{{ $pacote->trial_dias }} dias grátis</span>
                                </div>
                            </div>
                        </th>
                    @endforeach
            ...
            <tbody>
                            ...
                            <td class="value-cell">
                                ...
                                @if($temRecurso && $recurso)
                                    <div class="value-content">
                                        ...
                                        @else
                                            <span class="value-number">{{ number_format($limiteValor, 0, '.', '.') }}</span>
                                            @if($recurso->unidade !== 'quantidade')
                                                <span class="value-unit">{{ $recurso->unidade }}</span>
                                            @endif
                                        @endif
                                    </div>
                                @else
                ...
                <tr class="feature-row">
                    ...
                    @foreach($pacotes as $pacote)
                        <td class="value-cell">
                            @if($pacote->getNivelMaximo() && in_array($pacote->getNivelMaximo()->nivel, ['premium', 'enterprise']))
                ...
                <tr class="feature-row">
                    ...
                    @foreach($pacotes as $pacote)
                        <td class="value-cell">
                            @if($pacote->getNivelMaximo() && $pacote->getNivelMaximo()->nivel === 'enterprise')
                                <div class="check-content">
                                    <i class="fas fa-check-circle text-success"></i>
                    ...
                    @foreach($pacotes as $pacote)
                        <td class="value-cell">
                            <div class="trial-content">
                                <span class="trial-days">{{ $pacote->trial_dias }}</span>
