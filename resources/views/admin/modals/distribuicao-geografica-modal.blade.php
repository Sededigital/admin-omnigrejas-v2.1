                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <span class="badge bg-success">{{ array_sum(array_column($this->graficoDistribuicaoGeografica, 'total')) }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                            @foreach($this->graficoDistribuicaoGeografica as $regiao)
                                                @php
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="alert alert-info border-0">
                                                ...
                                                <strong>Região Principal:</strong> {{ $this->estatisticasGeograficas['regiao_mais_populosa'] ?? 'N/A' }}
                                                concentra {{ $this->graficoDistribuicaoGeografica[0]['total'] ?? 0 }} membros
                                            </div>
                                            <div class="alert alert-success border-0">
                                                <i class="fas fa-users text-success me-2"></i>
                                                <strong>Oportunidade:</strong> {{ $this->usuariosProximos['mesma_cidade'] ?? 0 }} membros
                                            ...
                                            <div class="alert alert-warning border-0">
                                                ...
                                                {{ $this->estatisticasGeograficas['media_por_regiao'] ?? 0 }} membros ou menos
                                            </div>
                                        </div>
                                    </div>
                                </div>
